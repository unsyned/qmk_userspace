...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(KC_TAB, KC_J, KC_L, KC_Y, KC_P, KC_K, KC_Z, KC_F, KC_O, KC_U, KC_QUOT, KC_BSPC,
                            LCTL_T(KC_ESC), LCTL_T(KC_C), LALT_T(KC_R), LGUI_T(KC_S), LSFT_T(KC_T), KC_G, KC_M, RSFT_T(KC_N), RGUI_T(KC_E), RALT_T(KC_I), RCTL_T(KC_A), KC_ENT,
                            KC_LSFT, KC_W, KC_Q, KC_V, KC_D, KC_B, KC_X, KC_H, KC_SLSH, KC_COMM, KC_DOT, KC_LSFT,
                            MO(2), TD(TD_SHIFT_CW), LT(2, KC_BSPC), LT(3, KC_SPC), KC_ENT, MO(3)
                            ),
    // TODO: ~remove qwerty layer~ and add way to get to gaming layer. also add gaming num layer
    // qwerty
    ...
    [1] = LAYOUT_split_3x6_3(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC,
                            ...
                            KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_M, KC_N, KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_ENT),
                            KC_RALT, MO(2), KC_SPC, KC_SPC, MO(3), KC_LGUI
                            ),
    // symbol
    [2] = LAYOUT_split_3x6_3(_______, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_TILDE, KC_GRV, _______,
                            ...
                            _______, _______, KC_COLN, KC_SCLN, _______, KC_GRV, KC_UNDS, KC_MINUS, KC_PLUS, KC_EQL, KC_QUES, _______,
                            _______, _______, _______, KC_ESC, KC_TAB, _______),
    // nav
    [3] = LAYOUT_split_3x6_3(_______, KC_MINUS, KC_7, KC_8, KC_9, KC_COMM, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_INS,_______,
                            _______, LCTL_T(KC_0), LALT_T(KC_1), LGUI_T(KC_2), LSFT_T(KC_3), KC_COLN, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL, _______,
                            _______, KC_PLUS, KC_4, KC_5, KC_6, KC_DOT, KC_PSCR, CW_TOGG, KC_CAPS, KC_RSFT, OSL(4), _______,
                            _______, KC_TAB, KC_ENT, _______, _______, _______),
    // fn
    // TODO: add toggle gaming layer and qwerty
    [4] = LAYOUT_split_3x6_3(RM_TOGG, KC_F12,KC_F7,KC_F8,KC_F9,_______,_______,_______,_______,_______,_______,_______,
...
const key_override_t del_override = ko_make_basic(MOD_MASK_SHIFT, LT(2, KC_BSPC), KC_DEL);
const key_override_t ltab_override = ko_make_basic(MOD_BIT(KC_LSFT), LT(3, KC_SPC), KC_TAB);
