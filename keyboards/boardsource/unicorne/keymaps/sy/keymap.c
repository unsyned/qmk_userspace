...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(KC_TAB, KC_J, KC_L, KC_Y, KC_P, KC_K, KC_Z, KC_F, KC_O, KC_U, KC_QUOT, KC_BSPC,
                            ...
                            KC_LSFT, KC_W, KC_Q, KC_V, KC_D, KC_B, KC_X, KC_H, KC_SLSH, KC_COMM, KC_DOT, KC_RSFT,
                            KC_ESC, MO(2), KC_BSPC, KC_SPC, MO(3), KC_ENT
                            ),
    // qwerty
    ...
    [2] = LAYOUT_split_3x6_3(_______, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_TILDE, KC_GRV, _______,
                            _______, KC_LABK, KC_LBRC, KC_LCBR, KC_LPRN, KC_BSLS, KC_PIPE, KC_RPRN, KC_RCBR, KC_RBRC, KC_RABK, _______,
    ...
    // nav
    [3] = LAYOUT_split_3x6_3(_______, KC_MINUS, KC_7, KC_8, KC_9, KC_SLSH, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_INS,_______,
                            _______, KC_MINUS, KC_4, KC_5, KC_6, KC_ASTR, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL, _______,
                            _______, KC_PLUS, KC_1, KC_2, KC_3, KC_TAB, KC_PSCR, CW_TOGG, KC_CAPS, KC_RSFT, OSL(5), _______,
                            _______, KC_0, KC_ENT, _______, _______, _______),
    // gaming num - it functions with esdf.
    [4] = LAYOUT_split_3x6_3(_______, KC_1, KC_2,_______, KC_3, KC_4,_______,_______,_______,_______,_______,_______,
    ...
    [5] = LAYOUT_split_3x6_3(RGB_TOG, KC_F12,KC_F7, KC_F8, KC_F9,_______,_______,_______,_______, TG(1),_______,_______,
